...
Clock::Clock(const unsigned int communicateProcessesId_[NUM_CELLS + 1], const unsigned int actorId_, ActorFramework::ExecutionUnit *executionUnit_)
...
void Clock::processMessage(const int messageSize, const ActorFramework::Message::MessageData *messageData)
{
    logPrint(ActorFramework::Logger::LogLevel::ERROR, "ERROR: Clock: Should not receive messages");
}
void Clock::update() {
...
ActorFramework::Actor *Clock::createNewActor(const unsigned int actorId_, const char *messageData) {
